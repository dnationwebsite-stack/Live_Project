...
export function ProductManagement() {
  ...
  const [preview, setPreview] = useState(null); // ✅ for image preview blob
  ...
  // ✅ Clean blob URL when image changes
  useEffect(() => {
    return () => {
  ...
  // ✅ Scroll to top *after* form is visible
  setTimeout(() => {
    window.scrollTo({
      top: 0,
      behavior: "smooth"
    });
  }, 100); // slight delay ensures DOM updated
};
